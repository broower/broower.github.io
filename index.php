...
<head>
    <title>Broower Shop - магазин бескаркасной мебели</title>
    <meta charset="UTF-8">
...
<body class="animsition">
    ...
    <!-- header fixed -->
    <div class="wrap_header fixed-header trans-0-4">
        <!-- Logo -->
    ...
    <!-- Header -->
    <header class="header" style="height: 55px">
        <!-- Header desktop -->
        <div class="container-menu-header p-t-26">
            <div class="topbar2">
    ...
    <!-- Title Page -->
    <section class="bg-title-page flex-col-c-m" style="background-image: url(images/heading-pages-03.jpg);">
        <h6 class="l-text2 t-center">
            Бескаркасная мебель
        </h6>
    </section>
    ...
    <section class="parallax0 parallax100" style="background-image: url(images/bg-video-01.jpg);">
        <div class="overlay0 p-t-190 p-b-200">
            <div class="flex-col-c-m p-l-15 p-r-15">
                <h3 class="l-text1 fs-35-sm font-Claiborne font-100px">
                    Broower Shop
                </h3>
...
-->
    ...
    <!-- Instagram -->
    <section class="instagram p-t-50">
        ...
        <div class="flex-w p-l-15 p-r-15">
            <div class="flex-col-c w-size5 p-l-15 p-r-15 p-t-16 p-b-15 respon1">
                ...
                <span class="s-text11 t-center">
                    Доставка почтой РБ, бесплатная доставка в пределах г. Гродно.
				</span>
            </div>
            ...
            <div class="flex-col-c w-size5 p-l-15 p-r-15 p-t-16 p-b-15 bo2 respon2">
                ...
                <span class="s-text11 t-center">
                    При изготовлении бескаркасной мебели используются высококачественные материалы и наполнители.
				</span>
            </div>
            ...
            <div class="flex-col-c w-size5 p-l-15 p-r-15 p-t-16 p-b-15 respon1">
                ...
                <span class="s-text11 t-center">
                    Сервис работает круглосуточно без выходных и обеда.
				</span>
            </div>
        </div>
    </section>
        ...
        <div class="modal-dialog" role="document" data-dismiss="modal">
            ...
            <div class="wrap-video-mo-01">
                ...
                <div class="video-mo-01">
                    <iframe src="https://www.youtube.com/embed/KPv6C3KVGpE?rel=0&amp;showinfo=0" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
